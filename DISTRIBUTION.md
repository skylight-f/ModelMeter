...
```text
dist/AgentDesk-<version>-mac-<arch>.dmg
```
...
the **Security** section, click **Open Anyway** for `AgentDesk.app`, then confirm
...
This writes `dist/AgentDesk-<version>-mac-x86_64.dmg` and its `.sha256` file.
...
codesign --verify --deep --strict "/Volumes/AgentDesk/AgentDesk.app"
```

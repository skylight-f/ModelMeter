...
- Adds a rank emblem and command-radius orbit beside the quota rings for the rolling 28-day AI leadership score and Chinese title. Orbit nodes represent measured peak concurrency, while `person.3.fill` and `clock.fill` show today's agent count and AI hours; quota and usage remain the primary focus.
